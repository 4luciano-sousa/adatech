...
//	encontre todas as músicas dado um determinado gênero
	public List<Song> musicaPorGenero(String genero) {
        return getSongs().stream()
                .filter(song -> song.getGenre().equalsIgnoreCase(genero))
                .collect(Collectors.toList());
    }
	
// liste todos os gêneros em ordem alfabética
    ...
    public static void main(String[] args) {
        ...
        // Teste dos métodos
        System.out.println("Músicas do gênero Electronic:");
        songs.musicaPorGenero("Electronic").forEach(System.out::println);

        System.out.println("\nGêneros em ordem alfabética:");
        songs.listAllGenres().forEach(System.out::println);

        System.out.println("\nQuantidade de artistas distintos:");
        System.out.println(songs.countDistinctArtists());

        System.out.println("\nMúsicas ordenadas por mais tocadas:");
        songs.sortSongsByMostPlayed().forEach(System.out::println);

        System.out.println("\nTop 5 músicas:");
        songs.printTop5Songs();

        System.out.println("\nMúsicas do artista The Beatles:");
        songs.findSongsByArtist("The Beatles").forEach(System.out::println);

        System.out.println("\nMúsicas com prefixo 'Come':");
        songs.findSongsByPrefix("Come").forEach(System.out::println);

        System.out.println("\nMúsicas mais recentes que 2000:");
        songs.findSongsAfterYear(2000).forEach(System.out::println);
    }
